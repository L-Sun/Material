		...
		/*	Here we load all of the blog posts to the index. 
	        ...
	        $.get(ghost.url.api('posts', {limit: "all", include: "tags"})).done(function(data){
            	...
            	searchData.forEach(function(arrayItem){
					...
					var category_link = arrayItem.tags.map(function(v) {
						return '<a href="/tag/' + v.slug + '">' + v.name + '</a>'
					}).join(", ");

					var excerpt = arrayItem.html.replace(/<a href="#fn.*?rel="footnote">.*?<\/a>/gi, '');
